...
describe 'A State Social Worker', type: :feature do
  ...
  describe 'with Sensitive Persons' do
    before(:all) do
      login_user(user: STATE_SENSITIVE_SOCIAL_WORKER, path: snapshot_path)
    end

    describe 'privilege granted' do
      it 'should attach different_county_not_sensitive_not_sealed client' do
        search_client_and_select(label: 'Search for clients', query: different_county_not_sensitive_not_sealed.search_name,
    ...
    describe 'privilege revoked' do
      ...
      it 'should not be able to see same_county_sealed_not_sensitive client' do
      ...
      it 'should not be able to see different_county_sealed_not_sensitive client' do
      ...
      it 'should not be able to see no_county_sealed_not_sensitive client' do
