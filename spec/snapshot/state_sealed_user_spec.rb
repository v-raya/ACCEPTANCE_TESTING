  ...
  describe 'with Sealed' do
    ...
    describe 'privilege granted' do
      ...
      it 'should attach same_county_sealed_not_sensitive client' do
        search_client_and_select(label: 'Search for clients', query: same_county_sealed_not_sensitive.search_name,
      ...
      it 'should attach no_county_sealed_not_sensitive client' do
        search_client_and_select(label: 'Search for clients', query: no_county_sealed_not_sensitive.search_name,
