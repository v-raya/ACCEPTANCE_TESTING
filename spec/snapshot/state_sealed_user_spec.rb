  ...
  describe 'with Sealed' do
    ...
    describe 'privilege granted' do
      ...
      it 'should attach same_county_sealed_not_sensitive client' do
        ...
        wait_for_result_to_appear do
          find('strong.highlighted', text: same_county_sealed_not_sensitive.full_name).click
        end
      ...
      it 'should attach no_county_sealed_not_sensitive client' do
        ...
        find('strong.highlighted', text: no_county_sealed_not_sensitive.full_name).click
